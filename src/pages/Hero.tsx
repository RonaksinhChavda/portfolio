...
//         buttonRef.current.classList.add('animate-fadeIn');
//       }
//     }, 1000);
//   }, []);

//   return (
//     <div id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-r from-purple-900 to-blue-900">
...
//             <div className="relative w-64 h-64 mx-auto overflow-hidden rounded-full border-4 border-white shadow-xl transform hover:scale-105 transition-transform duration-300">
//               <img 
...
//               <span className="block text-blue-300">John Smith</span>
//             </h1>
            
//             <p 
//               ref={subtitleRef}
//               className="mt-4 text-xl md:text-2xl text-gray-200 opacity-0 transition-opacity duration-1000"
//             >
...
//             <button 
//               ref={buttonRef}
//               className="mt-8 px-8 py-3 bg-blue-500 text-white font-bold rounded-full hover:bg-blue-600 transition-colors duration-300 opacity-0 transition-opacity duration-1000"
//             >
//               View My Work
//             </button>
//           </div>
...
const Hero: React.FC = () => {
  ...
  const fullText = "Full Stack Developer specializing in React, TypeScript and Node.js";
  ...
  return (
    <div id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-r from-purple-900 to-blue-900">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-purple-500 rounded-full filter blur-3xl opacity-20 animate-pulse"
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          <div className="md:w-1/3">
            ...
            >
              ...
              <img 
                src="/api/placeholder/400/400" 
                alt="Developer" 
                className="relative w-full h-full object-cover transition-transform duration-500 hover:scale-110"
              />
            </div>
          </div>
          ...
          <div className="md:w-2/3 text-left">
            <h1 
              ...
              className="text-4xl md:text-6xl font-extrabold text-white opacity-0 transition-opacity duration-1000"
            >
              <span className="block bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-300 animate-gradient-x">Hi, I'm</span>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <a href="#about" className="text-white group">
          <svg className="h-10 w-10 transition-transform duration-300 group-hover:translate-y-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
          </svg>
        </a>
      </div>
      ...
      <div className="absolute top-0 left-0 w-64 h-64">
        <svg viewBox="0 0 100 100" className="w-full h-full opacity-20">
          <path d="M0,0 L100,0 L0,100 Z" fill="rgba(255,255,255,0.1)" className="animate-pulse" style={{animationDuration: '8s'}} />
        </svg>
      </div>
      <div className="absolute bottom-0 right-0 w-64 h-64">
        <svg viewBox="0 0 100 100" className="w-full h-full opacity-20">
          <path d="M100,100 L0,100 L100,0 Z" fill="rgba(255,255,255,0.1)" className="animate-pulse" style={{animationDuration: '8s'}} />
        </svg>
      </div>
    </div>
  );
